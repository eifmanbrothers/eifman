...
People’s Artist of Russia, the Laureate of the State Prize of the Russian Federation, the laureate of the Golden Mask and the Golden Soffit awards, the holder of the Order of Merit for the Fatherland, 1st class.
    `,
    ru: `
Народный артист России, лауреат Государственных премий России, премий «Золотая Маска» и «Золотой софит», кавалер ордена «За заслуги перед Отечеством» IV, III, II и I степеней
...
Обращения Эйфмана к творениям писателей и судьбам гениев, перевод литературных произведений и биографий великих исторических личностей на язык балета – погружение через физику в психику, через тело в дух, через слово в мысль. Его уникальная лексика и концептуальные авторские трактовки – это прорыв в ту запредельную область, где воплощается бесконечность внутренних миров.
  ...
  press: {
    title: {
      en: "Press about Boris Eifman",
      ru: "Пресса о Борисе Эйфмане",
    },
    items: [
      {
        src: {
          ru: "(Anna Kisselgoff, The New York Times)",
          en: "(Anna Kisselgoff, The New York Times)",
        },
        quote: {
          ru: "«Балетный мир, находящийся в поиске главного хореографа, может прекратить поиск. Он найден, и это – Борис Эйфман».",
          en: "“The ballet world in search of a major choreographer need search no more. He is Boris Eifman…”",
        },
      },
      {
        src: {
          ru: "(Clive Barnes, New York Post)",
          en: "(Clive Barnes, New York Post)",
        },
        quote: {
          ru: "«Теперь нет никаких сомнений в том, что хореограф Борис Эйфман – удивительный театральный волшебник... Пожалуй, единственное, в чем можно еще сомневаться, это является ли он последним ведущим хореографом XX века или первым хореографом века XXI-го».",
          en: "“There now need be no doubt that choreographer Boris Eifman – theatrical magician extraordinary – is here to stay. Perhaps the only doubt is whether he is the last major choreographer of the 20th century or the first of the 21st.”",
        },
      },
      {
        src: {
        ...
        quote: {
          ru: "«Борис Эйфман, вне всякого сомнения, – самый интересный российский хореограф. Ему присущ как личностный магнетизм, так и постоянная тяга к поискам нового».",
          en: "“Boris Eifman is undoubtedly the most interesting modern Russian choreographer. He has a magnetism of both his own personality and his constant desire for renewal.”",
        },
      },
      {
        src: {
          ru: "(Lewis Segal, Los Angeles Times)",
          en: "(Lewis Segal, Los Angeles Times)",
        },
        quote: {
          ru: "«Из всех хореографов, ставящих сюжетные спектакли для ведущих театров, российский романтик Борис Эйфман, в сущности, единственный, кто полностью соответствует XXI веку... Эйфман опережает эпоху».",
          en: "“Of the ballet choreographers making narrative works for major stages, Russian Romantic Boris Eifman is virtually the only one totally in touch with the 21st century… Eifman outpaces the zeitgeist.”",
        },
      },
      {
        src: {
          ru: "(Игорь Ступников, «Санкт-Петербургские ведомости»)",
          en: "(Igor Stupnikov, Sankt-Peterburgskie Vedomosti)",
        },
        quote: {
          ru: "«Самые сложные жизненные коллизии и философские проблемы Эйфман умеет разрешить с помощью пластики и танца, захватывающей дух динамики и «мертвых» статических пауз».",
          en: "“The most difficult life collisions and philosophic problems are solved by Eifman with the help of plastic and dance, breath-taking dynamics and  ‘dead’ static pauses.”",
        },
      },
      {
        src: {
          ru: "(Paula Citron, The Globe and Mail)",
          en: "(Paula Citron, The Globe and Mail)",
        },
        quote: {
          ru: "«Борис Эйфман – феномен. Это хореограф, которого любят ненавидеть циничные и упрямые балетные критики и которого бесконечно обожает аудитория».",
          en: "“Boris Eifman is a phenomenon. He is the choreographer that cynical, hard-nosed dance critics love to hate, but whom audiences shower with adoration.”",
        },
      },
    ],
  },
